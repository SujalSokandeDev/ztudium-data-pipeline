...
def ai_chat_completion(*, model: str = "gpt-4o", **kwargs):
    ...
    target_model = _map_model(model) if (_use_gemini or client is _gemini_client) else model
    ...
    try:
        ...
        if _is_provider_fatal(exc) and not _use_gemini and _gemini_client:
            ...
            return _call(_gemini_client, _map_model(model))
        raise
