...
WEBSITES = [
    {
        "name": "CitiesABC",
        "slug": "citiesabc",
        "domain": "citiesabc.com",
        "sitemap_url": "https://citiesabc.com/sitemap_index.xml",
    ...
    },
    {
        ...
        "sitemap_url": "https://businessabc.net/sitemap_index.xml",
        "auto_publish_enabled": False,
        "daily_publish_limit": 0,
    ...
    },
    {
        "name": "HedgeThink",
        "slug": "hedgethink",
        "domain": "hedgethink.com",
        "sitemap_url": "https://hedgethink.com/sitemap_index.xml",
        "auto_publish_enabled": False,
        "daily_publish_limit": 0,
    ...
    },
    {
        "name": "FashionABC",
        "slug": "fashionabc",
        "domain": "fashionabc.org",
        "sitemap_url": "https://fashionabc.org/sitemap_index.xml",
    ...
    },
    {
        "name": "TradersDNA",
        "slug": "tradersdna",
        "domain": "tradersdna.com",
        "sitemap_url": "https://tradersdna.com/sitemap_index.xml",
        "auto_publish_enabled": False,
        "daily_publish_limit": 0,
    ...
    },
    {
        ...
        "slug": "freedomx",
        "domain": "freedomx.com",
        "sitemap_url": "https://freedomx.com/sitemap_index.xml",
        "auto_publish_enabled": True,
        "daily_publish_limit": 4,
        "gsc_property": os.getenv("GSC_PROPERTY_FREEDOMX", ""),
        "ga4_property_id": os.getenv("GA4_PROPERTY_FREEDOMX", ""),
        "category": "gaming, esports, game guides, tier lists, live events, and player strategy content",
        "audience": "gamers, esports audiences, live-event followers, and players looking for practical game guidance",
    },
    {
        "name": "Wisdomia",
        "slug": "wisdomia",
        "domain": "wisdomia.ai",
        "sitemap_url": "https://wisdomia.ai/sitemap_index.xml",
        "auto_publish_enabled": False,
        "daily_publish_limit": 0,
    ...
    },
    {
        ...
        "slug": "sportsdna",
        "domain": "sportsdna.ai",
        "sitemap_url": "https://sportsdna.ai/sitemap_index.xml",
        "auto_publish_enabled": False,
        "daily_publish_limit": 0,
    ...
    },
    {
        ...
        "sitemap_url": "https://intelligenthq.com/sitemap_index.xml",
        "auto_publish_enabled": False,
        "daily_publish_limit": 0,
