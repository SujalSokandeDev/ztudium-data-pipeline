                ...
                keyword_payloads_by_key[key] = [
                    {
                        ...
                        "kd": min(9999.99, float(item.get("kd") or 0)),
                        "intent": clean_text(item.get("intent")) or None,
                        "opportunity_score": min(9999.99, float(item.get("opportunity_score") or 0)),
                        "freshness_score": min(9999.99, scores["freshness_score"]),
